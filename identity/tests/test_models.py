...
class MyAccountManagerTestCase(TestCase):
    ...
    def test_create_user(self):
        user = self.manager.create_user(email=self.email, username=self.username, password=self.password, location=self.location)
    ...
    def test_create_superuser(self):
        superuser = self.manager.create_superuser(email=self.email, username=self.username, password=self.password, location=self.location)
